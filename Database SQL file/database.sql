...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 02, 2014 at 08:48 AM
...
INSERT INTO `projects` (`PID`, `DID`, `PName`, `PStatus`, `PDate`, `TotFinacial`, `Response`, `PRemark`) VALUES
(1, 4501, 'test1', 'testing', '2014-11-19', 10000, 'sandharu1', 'database testing'),
(2, 4502, 'test2', 'testing2', '0000-00-00', 2321, 'ssa2', 'still test'),
(3, 4503, 'project003', 'test database project', '2014-12-02', 10003, 'res03', 'this only test db'),
(4, 4504, 'test4', 'testing4', '2014-11-22', 40000, 'ssa4', 'still test4'),
(5, 4505, 'project005', 'test database project5', '2014-11-05', 10005, 'res05', 'this only test db5'),
(6, 4506, 'project006', 'test database project6', '2014-11-06', 10006, 'res06', 'this only test db6'),
(7, 4507, 'project007', 'test database project7', '2014-11-07', 10007, 'res07', 'this only test db7'),
(8, 4508, 'project008', 'test database project8', '2014-11-08', 10008, 'res08', 'this only test db8'),
(9, 4509, 'project009', 'test database project9', '2014-11-09', 10009, 'res09', 'this only test db9'),
(10, 45010, 'project0010', 'test database project10', '2014-11-10', 100010, 'res010', 'this only test db10');
