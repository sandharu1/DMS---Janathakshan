            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <ol class="breadcrumb">
                            <li>
                                <i class="fa fa-pencil-square-o"></i> Create Program Stages
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal" action="createProgram.php" method="post">
                      ...
                      <div class="control-group <?php echo !empty($ProStartDateError)?'error':'';?>">
                      ...
                      <div class="control-group <?php echo !empty($ProEndDateError)?'error':'';?>">
                        ...
                        <div class="controls">
                            <input name="ProEndDate" type="text"  placeholder="Program End Date" value="<?php echo !empty($ProEndDate)?$ProEndDate:'';?>">
